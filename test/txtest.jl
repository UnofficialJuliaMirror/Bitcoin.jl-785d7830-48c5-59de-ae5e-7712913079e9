...
@testset "Transaction" begin
    ...
    @testset "Parsing" begin
        ...
        @testset "Inputs" begin
            ...
            @test tx.inputs[1].prev_tx == want
            @test tx.inputs[1].prev_index == 0
            ...
            @test Bitcoin.serialize(tx.inputs[1].script_sig) == want
    ...
    @testset "Serialize" begin
        ...
        @test BitcoinPrimitives.serialize(tx) == raw_tx
    end
...
@testset "SegWit Transactions" begin
    ...
    @testset "Parse Segwit" begin
        ...
        @test tx.inputs[1].witness.instructions == Script([hex2bytes(hex1), hex2bytes(hex2)]).instructions
    end
    @testset "Serialize" begin
        tx = Bitcoin.parse(IOBuffer(raw), false)::Tx
